		...
		<header className="p-4 dark:bg-gray-700 dark:text-gray-100 shadow-2xl">
			<div className="container flex justify-between items-center h-16 mx-auto">
				...
				<div className="items-center justify-center flex-shrink-0 flex">
					<Link to={'/'}>
						<h3 className='px-5 cursor-pointer'>Home</h3>
					</Link>
					{session ? (
						<div className='flex items-center justify-center gap-5'>
							<Link to={'/client'}>Service</Link>
							<h3 className='px-3 cursor-pointer  text-red-500 hover:bg-slate-200 rounded-md font-semibold text-lg border border-violet-700 p-1' onClick={handleLogout}>Log out</h3>
						</div>
					) : (
						<Link to={'/signin'}>
